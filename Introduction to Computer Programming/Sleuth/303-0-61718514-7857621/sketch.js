...
Officer: 7857621
CaseNum: 303-0-61718514-7857621
...
The first safe is in Torvald’s office. Crack it by doing the following:
	...
	- Make CrypticSafeValue0 equal to 10

	Whilst the mouse is being dragged:
	- Make CrypticSafeValue0 equal to 19

	When any key is pressed:
	- Make CrypticSafeValue0 equal to 2

	When any key is released:
	- Make CrypticSafeValue0 equal to 12

	Whilst the mouse is being dragged:
	- Make CrypticSafeValue1 equal to 37

	When any key is released:
	- Make CrypticSafeValue1 equal to 17

	When the mouse button is pressed:
	- Make CrypticSafeValue1 equal to 86

	Whilst the mouse is moving:
	- Make CrypticSafeValue1 equal to 43
...
var CrypticSafeValue0;
var CrypticSafeValue1;
...
function draw()
{
	...
	drawDial(200, CrypticSafeValue0, 48);
	pop();

	//Draw the lever
	push();
	translate(width - 125,256);
	drawLever(CrypticSafeValue1);
	pop();
