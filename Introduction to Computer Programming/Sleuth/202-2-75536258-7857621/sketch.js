...
Officer: 7857621
CaseNum: 202-2-75536258-7857621
...
function draw()
{
	...
	fill(255,0,255);
	textFont(Diggity);
	//text("shooters", 430,297);
	//text("Daisy,", 114,30);
	textFont(RonsFont);
	//text("despair", 204,261);
	//text("Oh", 17,30);
	//text("I", 423,192);
	fill(0,0,0);
